...
public class IHMQuestion2_2 extends JFrame {
    ...
    public IHMQuestion2_2() {
        ...
        JButtonObserver jbo1 =new JButtonObserver("observateur jbo1",contenu);
        JButtonObserver jbo2 =new JButtonObserver("observateur jbo2",contenu);
        JButtonObserver jbo3 =new JButtonObserver("observateur jbo3",contenu);
        ...
        JMouseObserver jmo1 =new JMouseObserver("observateur jmo1",contenu);
        JMouseObserver jmo2 =new JMouseObserver("observateur jmo2",contenu);
        JMouseObserver jmo3 =new JMouseObserver("observateur jmo3",contenu);
